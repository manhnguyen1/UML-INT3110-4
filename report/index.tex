...
\chapter{Phân tích tĩnh, phân tích động}
  ...
  \section{Lớp phân tích}
    ...
    \begin{itemize}
      \item \textbf{SignInController}
      \item \textbf{SystemStatusController}
      \item \textbf{ClassesController}
      \item \textbf{UsersController}
      \item \textbf{SubjectsController}
      \item \textbf{LectureController}
      \item \textbf{RegisterController}
    \end{itemize}
  ...
  \begin{figure}[ht]
    \centering
    \includegraphics[scale=0.3]{../pictures/projectdiagrams/sequence/{"Sign In Sequence Diagram"}.jpg}
  ...
  \begin{figure}[ht]
    \centering
    \includegraphics[scale=0.5]{../pictures/projectdiagrams/sequence/{"Sign Out Sequence Diagram"}.jpg}
  ...
  \begin{figure}[ht]
    \centering
    \includegraphics[scale=0.3]{../pictures/projectdiagrams/sequence/{"Edit Account Info Sequence Diagram"}.jpg}
