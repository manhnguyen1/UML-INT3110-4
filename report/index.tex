...
\section{Đặc tả yêu cầu}
  ...
  \begin{table}
    ...
    \begin{tabularx}{\textwidth}{lXX}
      \toprule
      \multicolumn{2}{l}{\textbf{Tên use case: }Nhập điểm} & \textbf{ID: }specialist01 \\
      \hline
      \multicolumn{3}{l}{\textbf{Tác nhân chính: }Chuyên viên} \\
      \hline
      \textbf{Mức độ quan trọng: }cao & \multicolumn{2}{l}{\textbf{Loại use case: }nghiệp vụ} \\
      \hline
      \multicolumn{3}{l}{\textbf{Mô tả: }Nhập điểm cho sinh viên} \\
      \hline
      \multicolumn{3}{l}{\textbf{Điều kiện khởi phát: }Chuyên viên xem kết quả học tập của sinh viên} \\
      \hline
      \multicolumn{3}{l}{
        \makecell[l]{
          \textbf{Quan hệ với các use case khác:}\\
      ...
      TT $\quad\qquad$ Thực hiện bởi & \multicolumn{2}{l}{Hành động} \\
      \hline
      $\quad 1\qquad\quad$ Chuyên viên & \multicolumn{2}{l}{Chọn một môn học} \\
      \hline
      $\quad 2\qquad\quad$ Chuyên viên & \multicolumn{2}{l}{Nhập điểm} \\
      \hline
      $\quad 3\qquad\quad$ Hệ thống & \multicolumn{2}{l}{Lưu điểm} \\
      \hline
      $\quad 4\qquad\quad$ Hệ thống & \multicolumn{2}{l}{Hiển thị lại kết quả} \\
      \bottomrule
    \end{tabularx}
  \end{table}
  \FloatBarrier
